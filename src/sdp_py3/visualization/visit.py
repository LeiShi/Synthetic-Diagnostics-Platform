...
class Point:
    ...
    def __init__(this, x, y, z, **data):
        ...
        this.Y = y
        this.Z = z
        this.DataNames = [item[0] for item in list(data.items())]
        this.Data = [item[1] for item in list(data.items())]
...
class Polygon:
    ...
    def __init__(this, points, pointnumbers, **data):
        ...
        this.DataNames = [s for s in list(data.keys())]
        this.Data = [v for v in list(data.values())]
