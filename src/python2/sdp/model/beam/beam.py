...
class Beam1D:
    ...
    def set_data(self,data,limits):
        ...
        Due to the computation of the limits (:func:`compute_limits <sdp.diagnostic.bes.bes.BES.compute_limits>`),
        ...
        :type data: e.g. :class:`XGC_Loader_BES <sdp.plasma.xgc.load_XGC_BES.XGC_Loader_BES>`
    ...
    def get_emis_lifetime(self,pos,t_):
        ...
        :math:`\varepsilon` is the emissivity computed in :func:`get_emis <sdp.diagnostic.beam.beam.Beam1D.get_emis>`, and
