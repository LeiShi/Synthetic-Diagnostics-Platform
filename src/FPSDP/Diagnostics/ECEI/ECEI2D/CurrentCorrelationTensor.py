...
from ....Plasma.PlasmaProfile import PlasmaProfile, ECEI_Profile
from ....Plasma.DielectricTensor import HotSusceptibility
from ....Maths.PlasmaDispersionFunction import Z
from ....GeneralSettings.UnitSystem import UnitSystem, cgs
from ....GeneralSettings.Exceptions import ModelInvalidError
...
class AnisotropicNonrelativisticMaxwellian(SourceCurrentCorrelationTensor):
    ...
    ***************
    ...
    :type plasma: :py:class:`FPSDP.Plasma.PlasmaProfile.ECEIProfile` 
    ...
    *********
    ...
    .. [shi16] Development of Fusion Plamsa Synthetic Diagnostics Platform and 
