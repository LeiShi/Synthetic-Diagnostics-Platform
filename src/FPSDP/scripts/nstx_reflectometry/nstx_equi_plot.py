...
eqf = netcdf_file('/p/gkp/lshi/XGC1_NSTX_Case/3D_fluctuations/equilibrium.cdf','r')
...
freqs = np.array([30,32.5,35,37.5,42.5,45,47.5,50,55,57.5,60,62.5,67.5,70,72.5,75])*1e9
