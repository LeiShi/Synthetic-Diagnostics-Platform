...
dx_top=[]
def pick_top():
    global fwr_top,fwr2_top,exp_top,dx_top
...
dx_bot=[]
def pick_bottom():
    global fwr_bot,fwr2_bot,exp_bot,dx_bot
...
def fit_top():
    global fwr_t_a,fwr_t_sa,fwr2_t_a,fwr2_t_sa,exp_t_a,expt_sa,xmax_t,xfit_t,fwr_fit_t,fwr2_fit_t,exp_fit_t
...
def fit_bot():
    global fwr_b_a,fwr_b_sa,fwr2_b_a,fwr2_b_sa,exp_b_a,expt_sa,xmax_b,xfit_b,fwr_fit_b,fwr2_fit_b,exp_fit_b
