...
from sdp.io.f90nml.namelist import NmlDict
...
class FWR3D_input_maker:
    ...
    def create_all_input_files(self):
        ...
        self.update_para()
        for ftype in list(self.FILE_NAMES.keys()):
    ...
    def create_executable_links(self):
        ...
        try:
            ...
            clean = input('Executable linknames already exist in {0}. Do you want to remove the existing ones and make new links?(y/n):  '.format(self.run_path))
            if 'n' in clean:
