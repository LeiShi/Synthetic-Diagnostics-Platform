...
import sdp.diagnostic.bes.bes as bes_
import sdp.plasma.xgc.loader_local as xgc_
...
def check_convergence_solid_angle_to_analy(R=0.5,Z=0.1,radius=0.4,Nth=100,Nr=10):
    ...
    """
    from sdp.math.funcs import solid_angle_disk, solid_angle_seg
    Nsample = 100
